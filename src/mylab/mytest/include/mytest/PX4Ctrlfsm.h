#ifndef MYTEST__PX4CTRLFSM_H
#define MYTEST__PX4CTRLFSM_H
#include "mytest/PX4Ctrlparam.h"
#include "mytest/ROScallback.h"
#include "mytest/controller.h"
#include <Eigen/Dense>
#include <ros/ros.h>
using namespace mytest_px4ctrlparam;
using namespace mytest_roscallback;
using namespace mytest_controller;
namespace mytest_px4ctrlfsm {
