#include <mytraj_utils/polynomial_traj.h>
namespace myego {
PolynomialTraj PolynomialTraj::minSnapTraj(const Eigen::MatrixXd &Pos,
...
PolynomialTraj PolynomialTraj::one_segment_traj_gen(
  ...
  By << start_pt(1), start_vel(1), start_acc(1), end_pt(1), end_vel(1),
      end_acc(1);
  Bz << start_pt(2), start_vel(2), start_acc(2), end_pt(2), end_vel(2),
      end_acc(2);
