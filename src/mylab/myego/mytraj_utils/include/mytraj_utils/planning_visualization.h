#ifndef MYPLANNING_VISUALIZATION_H_
#define MYPLANNING_VISUALIZATION_H_
#include <Eigen/Dense>
#include <ros/ros.h>
#include <vector>
...
public:
  ...
  // ego_planner::BsplineOptimizer::Ptr optimizer, double sleep_time, const int
  // start_iteration); void displayNewArrow(ros::Publisher& guide_vector_pub,
