#ifndef MYPOLYNOMIAL_TRAJ_H
#define MYPOLYNOMIAL_TRAJ_H
#include <Eigen/Dense>
#include <iostream>
#include <vector>
using std::vector;
...
public:
  ...
  minSnapTraj(const Eigen::MatrixXd &Pos, const Eigen::Vector3d &start_vel,
              const Eigen::Vector3d &end_vel, const Eigen::Vector3d &start_acc,
              const Eigen::Vector3d &end_acc, const Eigen::VectorXd &Time);

  static PolynomialTraj one_segment_traj_gen(
