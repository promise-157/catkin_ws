#ifndef MYUNIFORM_BSPLINE_H_
#define MYUNIFORM_BSPLINE_H_
#include <Eigen/Dense>
#include <vector>
using namespace std;
namespace myego {
...
private:
  ...
  double limit_vel_, limit_acc_, limit_ratio_,
      feasibility_tolerance_; // physical limits and time adjustment ratio
...
public:
  ...
  static void
  parameterizeToBspline(const double &ts,
