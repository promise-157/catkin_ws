...
#include <mytraj_utils/DataDisp.h>
#include <mytraj_utils/MultiBsplines.h>
...
private:
  ...
  mytraj_utils::DataDisp data_disp_;
  mytraj_utils::MultiBsplines multi_bspline_msgs_buf_;
  ...
  ros::Subscriber waypoint_sub_, odom_sub_, swarm_trajs_sub_,
      broadcast_bspline_sub_, trigger_sub_;
  ...
  void swarmTrajsCallback(const mytraj_utils::MultiBsplinesPtr &msg);
  void BroadcastBsplineCallback(const mytraj_utils::BsplinePtr &msg);
